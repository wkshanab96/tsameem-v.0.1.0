...
export const AIFileExpert = ({
  ...
  const handleAiQuery = async () => {
    ...
    try {
      ...
      // Here you would integrate with your N8N RAG system
      // For now, we'll simulate a response
      setTimeout(() => {
        const fileInfo = selectedFile
          ? `Based on the analysis of "${selectedFile.name}", `
          : "Based on the analysis of your documents, ";

        const aiResponseText =
          `${fileInfo}I found the following information related to your query:\n\n` +
          "This document contains engineering specifications for the project. " +
          "The key dimensions mentioned are 120mm x 85mm with a tolerance of ±0.5mm. " +
          "The material specified is aluminum alloy 6061-T6 with a surface treatment of anodizing.";
